    ...
    <>
      <div id="footer">
        <div className='container'>
          <div className="row pt-5 mt-5">
            <div className="col-lg-2 col-md-2 d-none d-md-block">
              <Link to="/" className="navbar-brand">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-ticket-perforated" viewBox="0 0 16 16">
            ...
            <div className="col-lg-2 col-md-2">
              ...
              <ul className="nav flex-column mt-3">
                <li className="nav-item mb-2 p-0"><a href="#" className="nav-link p-0">Biz Kimiz</a></li>
              </ul>
            </div>
            <div className="col-lg-2 col-md-3">
              <h5>İletişim</h5>
              <ul className="nav flex-column mt-3">
                <li className="nav-item mb-2 p-0"><a href="#" className="nav-link p-0">info@example.com</a></li>
                <li className="nav-item mb-2 p-0"><a href="#" className="nav-link p-0">0(123) 456 789</a></li>
              </ul>
            </div>
            <div className="col-lg-2 col-md-2">
              <h5>Yardım</h5>
              <ul className="nav flex-column mt-3">
                <li className="nav-item mb-2 p-0"><a href="#" className="nav-link p-0">Yardım/SSS</a></li>
                <li className="nav-item mb-2 p-0"><a href="#" className="nav-link p-0">Satış Kanalları</a></li>
              </ul>
            </div>
            <div className="col-lg-4 col-md-3">
              <h5>Bizi Takip Edin</h5>
              <div id="follow-us" className='mt-3'>
          ...
          <div id='text' className="text-center small mt-4">All Rights Reserved - 2023</div>
        </div>
      </div>
    </>
  )
